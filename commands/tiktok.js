        ...
        try {
                    ...
                    for (let i = 0; i < Math.min(20, mediaData.length); i++) {
                        ...
                        if (isVideo) {
                            await sock.sendMessage(chatId, {
                                video: { url: mediaUrl },
                                mimetype: "video/mp4",
                                caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗩𝗔𝗠𝗣𝗔𝗥𝗜𝗡𝗔 𝗩1"
                            }, { quoted: message });
                        } else {
                            await sock.sendMessage(chatId, {
                                image: { url: mediaUrl },
            ...
            if (videoUrl) {
                try {
                    ...
                    const caption = title ? `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗩𝗔𝗠𝗣𝗔𝗥𝗜𝗡𝗔\n\n📝 Title: ${title}` : "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗩𝗔𝗠𝗣𝗔𝗥𝗜𝗡𝗔 𝗩1";
                    ...
                    try {
                        const caption = title ? `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗩𝗔𝗠𝗣𝗔𝗥𝗜𝗡𝗔 𝗩1\n\n📝 Title: ${title}` : "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗩𝗔𝗠𝗣𝗔𝗥𝗜𝗡𝗔 𝗩1";
